// components/AmazonTracker/FeaturesSection.tsx
    ...
    <section className="w-full py-20 px-4 bg-white">
      <div className="max-w-[1444px] mx-auto">
        <div className="text-center space-y-4 mb-16">
          ...
          >
            Get the Edge: Realpricetracker Features for Amazon price tracking
          </h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 justify-center gap-8 max-w-5xl mx-auto">
