...
import HeroSection from '@/components/MyntraPriceTracker/HeroSection';
...
const MyntraPriceTracker: React.FC = () => {
...
export default MyntraPriceTracker;